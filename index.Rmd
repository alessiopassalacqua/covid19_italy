...
** Dashboard di Coronavirus **

Questa dashboard di Coronavirus offre una panoramica dell'epidemia di Coronavirus COVID-19 (2019-nCoV) del 2019. Questa dashboard è costruita con R utilizzando il framework Rmakrdown e può essere facilmente riprodotta da altri. Il codice può essere reperito presso la repository di github presso il seguente [link] (https://github.com/alessiopassalacqua/covid19_italy)

**Data**

I dati di input per questo dashboard sono scaricati dalla repository di OnData  [covid19italia](https://github.com/ondata/covid19italia) e provengono dai dati di riepilogo nazionale scaricati dal [sito della protezione civile](http://www.protezionecivile.gov.it/attivita-rischi/rischio-sanitario/emergenze/coronavirus/)
